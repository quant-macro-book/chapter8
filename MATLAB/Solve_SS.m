...
figure;
subplot(311);
plot(grid_a_NS,dist(:,1),'LineWidth',2);
xlim([grid_a_NS(1) 1.0]); %grid_a_NS(end)]);
title("生産性: s_{L}","FontWeight","Normal");
ylabel("密度","FontWeight","Normal")
subplot(312);
plot(grid_a_NS,dist(:,2),'LineWidth',2);
xlim([grid_a_NS(1) 5.0]); %grid_a_NS(end)]);
title("生産性: s_{M}","FontWeight","Normal");
ylabel("密度","FontWeight","Normal")
subplot(313);
plot(grid_a_NS,dist(:,3),'LineWidth',2);
xlim([grid_a_NS(1) 50]); %grid_a_NS(end)]);
title("生産性: s_{H}","FontWeight","Normal");
